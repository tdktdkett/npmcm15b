...
%
%   DSSTATS = GRPSTATS(DS,GROUPVARS), when DS is a dataset array or table, returns a
%   dataset/table DSSTATS that contains the mean, computed by group, for variables
...
%   well as one variable for each of the remaining dataset/table variables in DS.
...
%   DSSTATS = GRPSTATS(DS,GROUPVARS,WHICHSTATS), for a dataset array or table DS,
%   returns the statistics specified by WHICHSTATS, either as separate arrays
%   A, B, ..., or as a single dataset array or table DSSTATS.  WHICHSTATS can be a
