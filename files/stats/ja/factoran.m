...
%                    | 'promax' | function ]
%
% 'Rotate' が 'method' パラメータの有効な値として ROTATEFACTORS で
% 認識された上記の文字列の1つである場合、ROTATEFACTORS で受け入れた 
% 他のパラメータ 名前/値 の組み合わせのいずれも指定することになります。
%
...
%
%   参考 BIPLOT, OPTIMSET, PROCRUSTES, PRINCOMP, PCACOV, ROTATEFACTORS.
