classdef NaiveBayes < classreg.learning.internal.DisallowVectorOps
...
%   Use FITNAIVEBAYES to create a NaiveBayes object by fitting the
...
%
%      O = fitNaiveBayes([train1 train2],grp,'dist',{'normal','mvmn'});
%      cidx = O.predict([test1 test2]);
%      err_rate = sum(grp~=cidx)/(2*n) %mis-classification rate
%
%   See also FITNAIVEBAYES, FITCDISCR, FITCKNN, FITCSVM.
