...
%   DISTTOOL creates interactive plots of probability distributions. This
%   is an example that displays a plot of the cdf or pdf of the
...
if iscdf
    ...
    set(ud.yfield,'Style','text','BackgroundColor',get(ud.dist_fig,'Color'));
    set(ud.hline,'Visible','off');
    if discrete,
        set(ud.dline,'Marker','+','LineStyle','none');
    else
